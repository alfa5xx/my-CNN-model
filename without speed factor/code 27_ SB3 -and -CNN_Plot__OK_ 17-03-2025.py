...
TRAIN_EPOCHS = 200         # Number of epochs for training CNN
...
# ------------------------------------------------------------------------------
# Define the original CNN model architecture
...
# Define a lightweight CNN model for faster training (fewer layers/filters)
...
# ------------------------------------------------------------------------------
# Train the CNN model with improvements (adjustable model choice, epochs, and callbacks)
...
def find_optimal_path(model, start_edge, destination_edge, max_steps=30):
    ...
    #a combined score is computed from the CNN prediction and the simulated partial path evaluation.
...
# ------------------------------------------------------------------------------
# SUMO command setup
sumoBinary = "sumo"  # Use "sumo-gui" for visualization
