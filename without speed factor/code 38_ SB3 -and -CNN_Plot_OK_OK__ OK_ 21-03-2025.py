...
TRAIN_EPOCHS = 150         # Number of epochs for training CNN # default is 150
TRAIN_SIM_STEPS = 200      # Simulation steps for training data collection # default is 200
TEST_SIM_STEPS = 40        # Simulation steps for test data collection   # default is 40
