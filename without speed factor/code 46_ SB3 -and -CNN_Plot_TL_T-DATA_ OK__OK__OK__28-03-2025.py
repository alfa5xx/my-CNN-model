...
TRAIN_EPOCHS = 400            # Number of epochs for training CNN  # default was 150
TRAIN_SIM_STEPS = 450      # Simulation steps for training data collection# default was 200
TEST_SIM_STEPS = 90       # Simulation steps for test data collection # default was 40 
...
def train_cnn_model(X_train, Y_train, X_test, Y_test):
    ...
    early_stop = EarlyStopping(monitor='val_loss', patience=402, restore_best_weights=True)
