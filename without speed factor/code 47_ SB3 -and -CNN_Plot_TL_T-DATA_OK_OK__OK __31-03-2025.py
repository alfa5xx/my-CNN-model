...
TRAIN_EPOCHS = 800            # Number of epochs for training CNN  # default was         150  , 400
TRAIN_SIM_STEPS = 1000      # Simulation steps for training data collection# default was 200 , 450 
TEST_SIM_STEPS = 300       # Simulation steps for test data collection # default was     40  , 90
...
def train_cnn_model(X_train, Y_train, X_test, Y_test):
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=10) # default valie for factor=0.6, patience=5
...
if __name__ == "__main__":
    ...
    destination_edge = "E14"  # Replace with your actual destination edge ID
