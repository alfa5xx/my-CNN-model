...
# model.compile(
#     optimizer=Adam(learning_rate=0.0005),  # Custom learning rate
...
def train_cnn_model(X_train, Y_train, X_test, Y_test):
    ...
    # model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy']) # original code
    model.compile(
    optimizer=Adam(learning_rate=0.0005),  # Custom learning rate
    loss='categorical_crossentropy', 
    metrics=['accuracy']
...
#     verbose=1          # Print messages when reducing
# )
#------------------------------------
...
#     step_size=20,  # Number of epochs for half a cycle
#     scale_mode='cycle'
# )

# model.compile(
#     optimizer=Adam(learning_rate=cyclic_lr),
#     loss='categorical_crossentropy', 
#     metrics=['accuracy']
# )
#------------------------------------
