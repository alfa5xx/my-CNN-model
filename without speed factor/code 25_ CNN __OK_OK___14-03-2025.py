...
if __name__ == "__main__":
    ...
    start_edge =  "E10" #"edge_start_id"  # Replace with your actual start edge ID
    destination_edge =  "E13" # "edge_end_id"  # Replace with your actual destination edge ID

    # Collect training and test data
    X_train, Y_train = collect_training_data(start_edge, destination_edge, simulation_steps=200) #  200 , simulation_steps=100)
