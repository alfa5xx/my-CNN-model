...
TRAIN_EPOCHS = 50         # Number of epochs for training CNN
TRAIN_SIM_STEPS = 60      # Simulation steps for training data collection
...
if __name__ == "__main__":
    ...
    destination_edge = "E8"  # Replace with your actual destination edge ID
