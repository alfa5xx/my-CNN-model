...
TRAIN_EPOCHS = 30            # Number of epochs for training CNN
TRAIN_SIM_STEPS = 20      # Simulation steps for training data collection
TEST_SIM_STEPS = 10        # Simulation steps for test data collection
...
if __name__ == "__main__":
    ...
    start_edge = "E1"        # Replace with your actual start edge ID
