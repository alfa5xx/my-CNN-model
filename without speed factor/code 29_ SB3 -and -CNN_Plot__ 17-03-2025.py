...
TRAIN_EPOCHS = 400         # Number of epochs for training CNN
...
def extract_features(edge_id):
    ...
    try:
        ...
        # Optional: print feature statistics for debugging
        # print(f"Edge {edge_id}: density={vehicle_density}, tls={tls_value}, speed_factor={speed_factor}")
